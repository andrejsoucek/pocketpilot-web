...
import {
  faAngleDoubleDown, faArrowsAltH, faBars, faBookOpen, faBriefcase, faCalendar, faDatabase, faEnvelopeOpen, faExclamationTriangle,
...
export default function(el) {
  library.add(
    faAngleDoubleDown, faMapMarkedAlt, faBookOpen, faSyncAlt, faEnvelopeOpen, faSignOutAlt, faTable, faCalendar, faArrowsAltH,
